...
Users can create and edit a weekly timetable. The timetable serves as a template for generating calendar events.
...
This project prioritizes software engineering decision-making rather than simply implementing features.

For every major system, alternatives are evaluated and documented before implementation.

The goal is not only to build a working application but also to understand the tradeoffs behind architectural choices.